...
const LanguageSwitcher = () => {
  ...
  return (
    <div ref={menuRef} className="fixed bottom-20 right-4 z-50 flex items-center">
      {isOpen && (
      ...
      <button
        ...
        className="group p-4 bg-gray-800 dark:bg-gradient-tech hover:shadow-2xl rounded-2xl shadow-xl transition-all duration-300 hover:scale-110"
