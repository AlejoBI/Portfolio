...
const LanguageSwitcher = () => {
  ...
  return (
    <button
      ...
      className="group fixed bottom-20 right-4 z-50 p-4 bg-gray-800 dark:bg-gradient-tech hover:shadow-2xl rounded-2xl shadow-xl transition-all duration-300 hover:scale-110"
