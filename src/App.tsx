      ...
      <div className="relative z-10">
        <Layout dark={dark} toggleTheme={toggle}>
          ...
          <div id="experience" className="container mx-auto px-6 lg:px-20 mb-20" style={{ contentVisibility: "auto" }}>
            <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl p-8 md:p-12 shadow-xl border border-blue-200/50 dark:border-blue-500/20 transition-colors duration-200">
          ...
          <div id="skills" className="container mx-auto px-6 lg:px-20 mb-20" style={{ contentVisibility: "auto" }}>
            <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl p-8 md:p-12 shadow-xl border border-purple-200/50 dark:border-purple-500/20 transition-colors duration-200">
              <div className="flex items-center gap-3 mb-8">
                <div className="w-1 h-12 bg-gradient-tech rounded-full" />
                <h2 className="text-4xl font-bold text-gray-900 dark:text-white">
                  {t("skills.title")}
